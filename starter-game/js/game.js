...
function getQuestionData(e) {
  ...
  updateCurrentCorrect(
    questions["question" + e].optionA.correctResponse,
    questions["question" + e].optionB.correctResponse,
    questions["question" + e].optionC.correctResponse,
    questions["question" + e].optionD.correctResponse
  );
